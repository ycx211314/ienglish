...
MEDIA_ROOT= os.path.join(BASEPATH,'upload')
...
# Absolute path to the directory english.static files should be collected to.
...
# List of finder classes that know how to find english.static files in
# various locations.
STATICFILES_FINDERS = (
...
SECRET_KEY = 'h#6*e_bgey*gnyuv7@8lrae4_vftewkvno8u6-2)+xc0%c%p+$'

# List of callables that know how to import english.templates from various sources.
TEMPLATE_LOADERS = (
...
MIDDLEWARE_CLASSES = (
    ...
    'django.middleware.transaction.TransactionMiddleware',#事务处理
...
TEMPLATE_DIRS = (os.path.join(BASEPATH,'templates').replace('\\','/'),)
